          ...
          <div className="gs-card fade-in" style={{ position: 'fixed', top: '60px', right: '16px', zIndex: 10000, minWidth: '220px' }}
            ...
            <button
              onPointerDown={(e) => {
                ...
                e.preventDefault();
                setShowMenu(false);
                setTimeout(() => setShowEditProfile(true), 50);
              }}
              className="w-full text-left font-semibold py-3 px-3 flex items-center gap-3 rounded-xl"
              style={{ color: 'var(--gs-forest)', fontSize: '1rem', background: 'transparent', border: 'none', cursor: 'pointer', position: 'relative', zIndex: 10001 }}>
            ...
            <button
              onPointerDown={(e) => { e.stopPropagation(); signOut(); setShowMenu(false); }}
              className="w-full text-left font-semibold py-3 px-3 flex items-center gap-3 rounded-xl"
              style={{ color: 'var(--gs-coral)', fontSize: '1rem', background: 'transparent', border: 'none', cursor: 'pointer', position: 'relative', zIndex: 10001 }}>
              <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
